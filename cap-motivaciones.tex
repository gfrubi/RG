...
\begin{center}
\begin{figure}[H]
\centerline{\psfig{file=fig/fig-ley-gravitacion-Newton.pdf,height=4cm,angle=0}}
...
\begin{center}
\begin{figure}[H]
\centerline{\psfig{file=fig/fig-tests-PED.pdf,height=5cm,angle=0}}
...
\begin{center}
\begin{figure}[H]
\centerline{\psfig{file=fig/fig-equivalencia.pdf,height=4cm,angle=0}}
...
\begin{figure}[H]
\centering\epsfig{file=fig/fig-SRLI.pdf, width=6cm}
...
\begin{figure}[H]
\centering\epsfig{file=fig/fig-gravedad-y-aceleracion-luz.pdf, width=6cm}
