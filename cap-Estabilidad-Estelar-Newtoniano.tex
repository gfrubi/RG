...
%\end{align}
%Pero podemos usar \eqref{masaparcial-laneemden} (evaluada en $x=x_1$) para encontrar una expresión para la escala de longitud $a$ en términos de las variables antes señaladas:
%\begin{equation}
