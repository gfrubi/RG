...
\caption{Energ'ias de 'orbitas circulares ecuatoriales, para $a=0.55m$. C'odigo Python \href{https://github.com/gfrubi/GR/blob/master/figuras-editables/fig-Ecirc.py}{aqu\'i}.}
\label{fig:Ecirc}
\end{center}
\end{figure}
...
Vemos que si $a=0$ entonces $r_{\rm ll}=4m$ y para $a=m$, $r_{\rm ll}^+=m$ si la part\'icula gira en el mismo sentido que el agujero y $r_{\rm ll}^-=5.83m$ si la rotaci\'on es retrograda con respecto al agujero.
