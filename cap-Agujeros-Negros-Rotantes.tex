...
\begin{equation}\label{88}
 \frac{2a^2\Delta}{\rho^2}(c\dot{t}-a\sen^2\theta\dot{\varphi})^2-\frac{2a\Delta \dot{\varphi}}{\rho^2}(c\dot{t}-a\sen^2\theta\dot{\varphi})-\frac{(r^2+a^2+a^2\sen^2\theta)}{\rho^2}\left[(r^2+a^2)\dot{\varphi}-ac\dot{t}\right]^2=0.
\end{equation}
...
\caption{Frecuencias angulares permitidas para orbitas circulares ecuatoriales.}
\label{fig:omegaecua}
\end{figure}
